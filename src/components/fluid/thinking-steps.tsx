// Ported from fluid-functionalism (registry/radix/thinking-steps.tsx) —
// verbatim except import paths rewritten for mne's layout:
//   @/lib/icon-context   → @/lib/fluid/icon-context
//   @/lib/springs        → @/lib/fluid/springs
//   @/lib/font-weight    → @/lib/fluid/font-weight
//   @/lib/shape-context  → @/lib/fluid/shape-context
//   @/lib/size-context   → @/lib/fluid/size-context
//   @/registry/default/badge → @/components/fluid/badge
// Requires the --hover/--active tokens and .shimmer-text class added to
// index.css/tailwind.config.ts, and @radix-ui/react-collapsible (installed).
"use client";
...
import type { IconName } from "@/lib/fluid/icon-context";
...
import { SizeProvider, useSize, type SizeVariant } from "@/lib/fluid/size-context";
