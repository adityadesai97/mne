// Ported from fluid-functionalism (registry/default/table.tsx) — verbatim
// except import paths rewritten for mne's layout:
//   @/lib/springs             → @/lib/fluid/springs
//   @/lib/font-weight         → @/lib/fluid/font-weight
//   @/lib/size-context        → @/lib/fluid/size-context
//   @/hooks/use-proximity-hover → @/lib/fluid/use-proximity-hover
// Requires the --hover/--active tokens added to index.css/tailwind.config.ts.
"use client";
...
import { useProximityHover } from "@/lib/fluid/use-proximity-hover";
