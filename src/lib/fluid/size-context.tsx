// Ported from fluid-functionalism (registry/default/lib/size-context.tsx) —
// verbatim. `useSize()` falls back to the "default" (36px) step with no
// provider mounted, so mne doesn't need a global <SizeProvider>.
"use client";
