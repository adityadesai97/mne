// Ported from fluid-functionalism (registry/default/lib/icon-context.tsx) —
// verbatim. Uses lucide-react, already a mne dependency. `useIcon()` falls
// back to this file's Lucide defaults with no provider mounted.
"use client";
