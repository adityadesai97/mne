// Ported from fluid-functionalism (registry/default/lib/shape-context.tsx) —
// verbatim. `useShape()` falls back to the `pill` preset with no provider
// mounted, so mne doesn't need a global <ShapeProvider> for ported components
// to render correctly.
"use client";
