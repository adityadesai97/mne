...
function makeIsConfigured(claudeKey: string, groqKey: string, provider: string, finnhubKey: string, needsSignIn: boolean) {
  const activeKey = provider === 'groq' ? groqKey : claudeKey
