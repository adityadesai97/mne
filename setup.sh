...
echo ""
echo "  Once you've applied the SQL schema and configured Google OAuth, start the app:"
echo ""
echo -e "     ${BOLD}npm run dev${RESET}"
echo ""
echo "  Then open:  ${BOLD}http://localhost:5173${RESET}"
echo ""
echo "  On first sign-in you'll be prompted in-app for:"
